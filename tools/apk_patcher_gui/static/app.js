...
function options() {
  return {
    ...
    do_install: String(value("do_install")), rebuild_hook: String(value("rebuild_hook")), device_serial: value("device_serial"),
    legible: defaults.legible || "", zipalign: defaults.zipalign || "",
